...
DATA_DIR    = Path('/data')      # Read-only input
RESULTS_DIR = Path('/results')   # Writable output
LOG_DIR     = RESULTS_DIR / "logs"
FOR_RESULTS = RESULTS_DIR / "forecasting"
...
def save_results(all_records: List[Dict], logger: logging.Logger) -> Path:
    FOR_RESULTS.mkdir(parents=True, exist_ok=True)
    path = FOR_RESULTS / f"forecast_results_{RUN_ID}.csv"
