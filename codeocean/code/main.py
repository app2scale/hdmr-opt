...
# =============================================================================
# Code Ocean Paths & Configuration
# =============================================================================
DATA_DIR    = Path('/data')      # Read-only input data (linked datasets)
RESULTS_DIR = Path('/results')   # Writable output directory
...
def setup_logging(run_id: str) -> logging.Logger:
    ...
    logger.info("=" * 70)
    logger.info("Code Ocean Capsule  |  HDMR-opt LightGBM HPO  |  16 Datasets")
